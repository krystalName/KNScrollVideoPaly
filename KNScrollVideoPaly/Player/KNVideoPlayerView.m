...
- (UIView *)bottomBar {
    if (!_bottomBar) {
        ...
        KNVideoSlider *slider = [[KNVideoSlider alloc] init];
        slider.value = 0.0f;
        ...
        self.slider = slider;
        __weak typeof(self) weakSelf = self;
        slider.valueChangeBlock = ^(KNVideoSlider *slider){
            [weakSelf sliderValueChange:slider];
        };
        slider.finishChangeBlock = ^(KNVideoSlider *slider){
            [weakSelf finishChange];
        };
        slider.draggingSliderBlock = ^(KNVideoSlider *slider){
            [weakSelf dragSlider];
        };
